...
#SBATCH --job-name=hyp_cont_replay_p1                    # job name
...
NAMES=(
  "prv_1_prop1" "prv_5_prop1" "prv_10_prop1" "prv_20_prop1" "prv_50_prop1"
  "all_1_no_dec_prop1" "all_1_dec50_prop1" "all_1_dec10_prop1"
  "all_5_no_dec_prop1" "all_5_dec50_prop1" "all_5_dec10_prop1"
  "all_10_no_dec_prop1" "all_10_dec50_prop1" "all_10_dec10_prop1"
  "all_20_no_dec_prop1" "all_20_dec50_prop1" "all_20_dec10_prop1"
  "all_50_no_dec_prop1" "all_50_dec50_prop1" "all_50_dec10_prop1"
)
