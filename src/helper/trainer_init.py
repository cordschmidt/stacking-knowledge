...
def create_trainer(cfg: BabyLMConfig, model, tokenizer, train_dataset, eval_dataset, curriculum_learning_table):
    ...
    training_args = TrainingArguments(
        ...
        eval_steps=cfg.trainer.max_training_steps // (2 if cfg.experiment.dry_run else 20),

        # Save checkpoint every N steps (same as eval steps)
        save_steps=cfg.trainer.max_training_steps // (2 if cfg.experiment.dry_run else 20),
